...
- text: infra-0 H
- button "Focus on Map"
- text: INFRA 0 91% 18s infra-1 H
- button "Focus on Map"
- text: INFRA 1 99% 3m infra-2 H
- button "Focus on Map"
- text: INFRA 2 86% 1m infra-3 H
- button "Focus on Map"
- text: INFRA 3 87% 4m infra-4 H
- button "Focus on Map"
- text: INFRA 4 93% 2m infra-5 H
- button "Focus on Map"
- text: INFRA 5 90% 23s infra-6 H
- button "Focus on Map"
- text: INFRA 6 93% 4m
- button "AUTO"
- button "CENTER"
...
- heading "Settings" [level=3]:
  - button "Settings"
- button
- text: Ready Gates fonts 145ms store 19ms map — simWorker — perfWorker — heatmaps — 2/6 ready Fictional, abstract simulation • No real-world guidance
- alert
```